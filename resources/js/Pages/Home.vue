<template>
  <Layout>
    <!-- HERO SECTION – 80% of viewport height -->
    <div id="hero" class="h-[80vh] relative overflow-hidden">

      <!-- Fixed Navigation -->
      <nav id="nav" class="fixed inset-x-0 top-0 flex flex-row justify-between z-10 text-white bg-transparent">

        <!-- Nav Items (Tablet & Desktop) -->
        <!-- <div class="p-4 hidden md:flex flex-row justify-between font-bold">
          ...
          <a href="#whyus" class="mx-4 text-lg border-b-2 border-transparent hover:border-b-2 hover:border-indigo-300 transition duration-500">Why Us?</a>
          <a href="#showcase" class="mx-4 text-lg border-b-2 border-transparent hover:border-b-2 hover:border-indigo-300 transition duration-500">Our Products</a>
        </div> -->
      ...
      <div id="nav-opened" class="fixed left-0 right-0 hidden bg-white mx-2 mt-16 rounded-br rounded-bl shadow z-10 md:hidden">
      ...
      <header id="up" class="bg-center bg-fixed bg-no-repeat bg-cover h-full w-full relative">
        <!-- Dark Overlay + Centered Content -->
        <div class="h-full bg-black/50 flex items-center justify-center">
          <div class="mx-2 text-center">
            <h1 class="text-white font-extrabold text-4xl xs:text-5xl md:text-6xl" style="color:white;">
...
<!-- 
    <section class="bg-white dark:bg-gray-900">
        <div class="py-8 lg:py-16 mx-auto max-w-screen-xl px-4">
            <h2 class="mb-8 lg:mb-16 text-3xl font-extrabold tracking-tight leading-tight text-center text-gray-900 dark:text-white md:text-4xl">Our patners</h2>
            <div class="grid grid-cols-3 gap-8 text-gray-500 sm:gap-12 md:grid-cols-3 lg:grid-cols-3 dark:text-gray-400">
        ...
        <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
            ...
            <div class="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
                <div>
                    ...
                    <h3 class="mb-2 text-xl font-bold dark:text-white">Real Listings. Real People.</h3>
                    <p class="text-gray-500 dark:text-gray-400">Every property on our platform is verified, with high-quality photos, detailed descriptions, and up-to-date pricing — so you can make confident decisions before you even book a viewing.</p>
                </div>
                <div>
                    <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-blue-100 lg:h-12 lg:w-12 dark:bg-blue-900">
                    ...
                    <h3 class="mb-2 text-xl font-bold dark:text-white">Explore by Neighborhood</h3>
                    <p class="text-gray-500 dark:text-gray-400">Discover homes in the areas you love. Compare prices, amenities, and commute times to find the best fit for your lifestyle.</p>
                </div>
                <div>
                    <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-blue-100 lg:h-12 lg:w-12 dark:bg-blue-900">
                    ...
                    <h3 class="mb-2 text-xl font-bold dark:text-white">Start Your Home Journey Today</h3>
                    <p class="text-gray-500 dark:text-gray-400">Finding your dream home doesn’t have to be overwhelming. Whether you’re renting or buying, we’ll guide you every step of the way.</p>
                </div>
                <div>
                    <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-blue-100 lg:h-12 lg:w-12 dark:bg-blue-900">
                    ...
                    <h3 class="mb-2 text-xl font-bold dark:text-white">Guided by What Matters to You</h3>
                    <p class="text-gray-500 dark:text-gray-400">Tell us what you’re looking for — from budget to bedroom count, pet-friendly spaces, or proximity to work or school — and we’ll match you with homes that fit your exact needs. No more sifting through irrelevant listings.</p>
                </div>
                <div>
                    <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-blue-100 lg:h-12 lg:w-12 dark:bg-blue-900">
                    ...
                    <h3 class="mb-2 text-xl font-bold dark:text-white">Experience Homes Virtually</h3>
                    <p class="text-gray-500 dark:text-gray-400">Tour your future home from anywhere. With 360° virtual tours, interactive photo galleries, and video walkthroughs, you can explore every corner before you visit in person.</p>
                </div>
                <div>
                    <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-blue-100 lg:h-12 lg:w-12 dark:bg-blue-900">
      ...
      <section class="bg-white dark:bg-gray-900">
        <div class="gap-16 items-center py-8 px-4 mx-auto max-w-screen-xl lg:grid lg:grid-cols-2 lg:py-16 lg:px-6">
            <div class="font-light text-gray-500 sm:text-lg dark:text-gray-400">
                ...
                <p class="mb-4">At Afrihomes, we simplify the home-hunting process with easy-to-use tools, verified listings, and tailored recommendations. Whether you're buying or renting, we ensure a stress-free search, helping you find your perfect space—fast and with confidence.</p>
                <p>Each listing on AfriHomes is verified, ensuring that the details you see are accurate and up-to-date.</p>
            </div>
            <div class="grid grid-cols-2 gap-4 mt-8">
                <img class="w-full rounded-lg" src="https://images.pexels.com/photos/4450337/pexels-photo-4450337.jpeg" alt="office content 1">
    ...
    <section class="bg-gray-50 dark:bg-gray-900 dark:bg-gray-800">
        <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
            <div class="max-w-screen-lg text-gray-500 sm:text-lg dark:text-gray-400">
                <h2 class="mb-4 text-4xl font-bold text-gray-900 dark:text-white">Your Journey to the Perfect Home Starts Here</h2>
                <p class="mb-4 font-light">At AfriHomes, we believe finding the perfect home should be as easy and stress-free as possible. Whether you're searching for an affordable bedsitter, a spacious family home, or a luxurious mansion, our platform connects you to a wide variety of properties across Africa. With verified listings, high-quality photos, and real-time availability updates, we ensure you're getting the most accurate and up-to-date information. Our intuitive search tools and personalized recommendations help you find exactly what you need, while our neighborhood insights guide you in choosing a location that fits your lifestyle. At AfriHomes, we’re here to make your home search quicker, easier, and more enjoyable.</p>
                <p class="mb-4 font-medium">Searching for a home can often feel overwhelming, but at AfriHomes, we aim to simplify the entire process. Our platform is designed to help you find the perfect property, whether you’re looking for a cozy bedsitter, a family-friendly apartment, or a luxurious mansion. From the moment you land on our site, you'll find an intuitive interface that makes searching for homes easier than ever.</p>
...
header {
  background-image: url('https://images.pexels.com/photos/1446378/pexels-photo-1446378.jpeg');
}

/* Optional: Responsive background images per breakpoint */
/*
@media (min-width: 640px) {
  header { background-image: url('path/to/bg-640.jpg'); }
}
@media (min-width: 768px) {
  header { background-image: url('path/to/bg-768.jpg'); }
}
@media (min-width: 1024px) {
  header { background-image: url('path/to/bg-1024.jpg'); }
}
*/
</style>